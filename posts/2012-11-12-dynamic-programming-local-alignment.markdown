...
For more information regarding Dynamic Programming check <a href="http://www.biorecipes.com/DynProgBasic/code.html" title="here" target="blank">here</a> and <a href="http://en.wikipedia.org/wiki/Dynamic_programming" title="here" target="blank">here</a>
